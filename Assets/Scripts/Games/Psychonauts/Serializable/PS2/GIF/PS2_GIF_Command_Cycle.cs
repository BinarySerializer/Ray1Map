...
namespace Ray1Map.Psychonauts {
    ...
    public class PS2_GIF_Command_Cycle : BinarySerializable
    {
        ...
        public PS2_GIF_Vertex Vertex { get; set; }
        public PS2_GIF_Normal Normal { get; set; }
        public PS2_GIF_RGBA Color { get; set; }
        public PS2_GIF_UV[] UVs { get; set; }

        public override void SerializeImpl(SerializerObject s)
        {
			Vertex = s.SerializeObject<PS2_GIF_Vertex>(Vertex, x => x.Pre_JointInfluencesPerVertex = Pre_JointInfluencesPerVertex, name: nameof(Vertex));
			...
			Color = s.SerializeObject<PS2_GIF_RGBA>(Color, name: nameof(Color));
