...
namespace Ray1Map.GBAIsometric
{
    public static class GBAIsometric_Spyro_ObjInit
    {
        ...
        private static GBAIsometric_Dragon_ROM GetROM(Unity_Object_GBAIsometricSpyro obj) => obj.ObjManager.Context.GetMainFileObject<GBAIsometric_Dragon_ROM>(GBAIsometric_IceDragon_BaseManager.GetROMFilePath);
