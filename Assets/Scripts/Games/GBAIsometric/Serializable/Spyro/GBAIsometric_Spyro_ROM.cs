...
namespace Ray1Map.GBAIsometric
{
    public class GBAIsometric_Spyro_ROM : GBA_ROMBase
    {
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            DataTable = s.DoAt(pointerTable[Spyro_DefinedPointer.DataTable], () => s.SerializeObject<GBAIsometric_Spyro_DataTable>(DataTable, name: nameof(DataTable)));
            ...
            LevelData = s.DoAt<GBAIsometric_Spyro_LevelDataArray>(pointerTable.TryGetItem(Spyro_DefinedPointer.LevelData), () => s.SerializeObject(LevelData, x =>
            {
            ...
            LevelObjects = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.LevelObjects), () => s.SerializeObjectArray<GBAIsometric_Spyro_LevelObjects>(LevelObjects, LevelData.Length, name: nameof(LevelObjects)));

            if (s.GetR1Settings().EngineVersion == EngineVersion.GBAIsometric_Spyro2)
            {
                // Agent 9
                LevelData_Spyro2_Agent9 = s.DoAt<GBAIsometric_Spyro_LevelDataArray>(pointerTable[Spyro_DefinedPointer.LevelData_Spyro2_Agent9], () => s.SerializeObject(LevelData_Spyro2_Agent9, x =>
                {
                    x.Length = 4;
            ...
            else if (s.GetR1Settings().EngineVersion == EngineVersion.GBAIsometric_Spyro3)
            {
                ...
                LevelData_Spyro3_Agent9 = s.DoAt<GBAIsometric_Spyro_LevelDataArray>(pointerTable[Spyro_DefinedPointer.LevelData_Spyro3_Agent9], () => s.SerializeObject(LevelData_Spyro3_Agent9, x =>
                {
                    x.Length = 4;
                    x.UsesPointerArray = true;
                    x.Is2D = true;
                ...
                LevelObjects_Spyro3_Agent9 = s.DoAt(pointerTable[Spyro_DefinedPointer.LevelObjects_Spyro3_Agent9], () => s.SerializeObjectArray<GBAIsometric_Spyro_LevelObjects>(LevelObjects_Spyro3_Agent9, LevelData_Spyro3_Agent9.Length, name: nameof(LevelObjects_Spyro3_Agent9)));

                // Sgt. Byrd
                LevelObjects_Spyro3_SgtByrd = s.DoAt(pointerTable[Spyro_DefinedPointer.LevelObjects_Spyro3_SgtByrd], () => s.SerializeObjectArray<GBAIsometric_Spyro_SgtByrdInfo>(LevelObjects_Spyro3_SgtByrd, 4, name: nameof(LevelObjects_Spyro3_SgtByrd)));
                LevelObjects_Spyro3_ByrdRescue = s.DoAt(pointerTable[Spyro_DefinedPointer.LevelObjects_Spyro3_ByrdRescue], () => s.SerializeObjectArray<GBAIsometric_Spyro_ByrdRescueInfo>(LevelObjects_Spyro3_ByrdRescue, 22, name: nameof(LevelObjects_Spyro3_ByrdRescue)));

                id = GetLevelDataID(s.GetR1Settings());

                LevelData_Spyro3_SgtByrd = s.DoAt<GBAIsometric_Spyro_LevelDataArray>(pointerTable[Spyro_DefinedPointer.LevelData_Spyro3_SgtByrd], () => s.SerializeObject(LevelData_Spyro3_SgtByrd, x =>
                {
                    x.Length = 13;
                    x.UsesPointerArray = true;
                    x.Is2D = true;
            ...
            LevelMaps = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.LevelMaps), () => s.SerializeObjectArray<GBAIsometric_Spyro_LevelMap>(LevelMaps, manager.LevelMapsCount, name: nameof(LevelMaps)));

            // Serialize object data
            ObjectTypes = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.ObjectTypes), () => s.SerializeObjectArray<GBAIsometric_ObjectType>(ObjectTypes, manager.ObjectTypesCount, name: nameof(ObjectTypes)));
            AnimSets = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.AnimSets), () => s.SerializeObjectArray<GBAIsometric_Spyro_AnimSet>(AnimSets, manager.AnimSetsCount, name: nameof(AnimSets)));

            // Serialize portraits
            PortraitSprites = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.PortraitSprites), () => s.SerializeObjectArray<GBAIsometric_Spyro_PortraitSprite>(PortraitSprites, manager.PortraitsCount, name: nameof(PortraitSprites)));
            ...
            LevelIndices = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.LevelIndices), () => s.SerializeArray<byte>(LevelIndices, manager.TotalLevelsCount, name: nameof(LevelIndices)));
            LevelNameInfos = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.LevelNameInfos), () => s.SerializeObjectArray<GBAIsometric_Spyro_LevelNameInfo>(LevelNameInfos, manager.TotalLevelsCount, name: nameof(LevelNameInfos)));
            LevelNames = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.LevelNames), () => s.SerializeObjectArray<GBAIsometric_LocIndex>(LevelNames, manager.TotalLevelsCount, name: nameof(LevelNames)));
            MenuPages = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.MenuPages), () => s.SerializeObjectArray<GBAIsometric_Spyro_MenuPage>(MenuPages, manager.MenuPageCount, name: nameof(MenuPages)));
            ...
            States_Spyro3_NPC = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.States_Spyro3_NPC), () => s.SerializeObjectArray<GBAIsometric_Spyro3_State_NPC>(States_Spyro3_NPC, 49, name: nameof(States_Spyro3_NPC)));
            States_Spyro3_DoorTypes = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.States_Spyro3_DoorTypes), () => s.SerializeObjectArray<GBAIsometric_Spyro3_State_DoorTypes>(States_Spyro3_DoorTypes, 49, name: nameof(States_Spyro3_DoorTypes)));
            States_Spyro3_DoorGraphics = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.States_Spyro3_DoorGraphics), () => s.SerializeObjectArray<GBAIsometric_Spyro3_State_DoorGraphics>(States_Spyro3_DoorGraphics, 22, name: nameof(States_Spyro3_DoorGraphics)));
            States_Spyro2_LevelObjectives = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.States_Spyro2_LevelObjectives), () => s.SerializeObjectArray<GBAIsometric_Spyro2_State_LevelObjective>(States_Spyro2_LevelObjectives, 14, name: nameof(States_Spyro2_LevelObjectives)));
            States_Spyro2_Portals = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.States_Spyro2_Portals), () => s.SerializeObjectArray<GBAIsometric_Spyro2_State_Portal>(States_Spyro2_Portals, 25, name: nameof(States_Spyro2_Portals)));
            States_Spyro2_ChallengePortals = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.States_Spyro2_ChallengePortals), () => s.SerializeObjectArray<GBAIsometric_Spyro2_State_ChallengePortal>(States_Spyro2_ChallengePortals, 10, name: nameof(States_Spyro2_ChallengePortals)));

            QuestItems = s.DoAt(pointerTable.TryGetItem(Spyro_DefinedPointer.QuestItems), () => s.SerializeObjectArray<GBAIsometric_Spyro3_QuestItem>(QuestItems, 104, name: nameof(QuestItems)));
