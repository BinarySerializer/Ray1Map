...
namespace Ray1Map.GBAIsometric
{
    ...
    public class GBAIsometric_Ice_Level3D_MapCollisionItem : BinarySerializable
    {
        ...
        public byte AdditionalDataLength { get; set; }
        ...
        // Parsed later
        public GBAIsometric_Ice_Level3D_MapCollisionAdditionalDataItem[] AdditionalData { get; set; } // Optional 4 lines?

        public override void SerializeImpl(SerializerObject s)
        {
            Height = s.Serialize<UInt24>(Height, name: nameof(Height));
            AdditionalDataLength = s.Serialize<byte>(AdditionalDataLength, name: nameof(AdditionalDataLength));
