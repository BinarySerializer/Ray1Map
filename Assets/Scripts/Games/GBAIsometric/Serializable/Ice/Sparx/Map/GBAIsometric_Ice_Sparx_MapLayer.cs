...
namespace Ray1Map.GBAIsometric
{
    public class GBAIsometric_Ice_Sparx_MapLayer : BinarySerializable
    {
        ...
        public BinarySerializer.Nintendo.GBA.MapTile[] GetMap(GBAIsometric_Ice_Sparx_TileSetMap tileSetMap)
        {
            BinarySerializer.Nintendo.GBA.MapTile[] map = new BinarySerializer.Nintendo.GBA.MapTile[Width * 2 * Height * 2];
