...
{
    public class Unity_Object_GBAIsometricSpyro : Unity_SpriteObject_3D
    {
        ...
        public override Unity_ObjectType Type => IsWaypoint ? Unity_ObjectType.Waypoint : IsEditorObj ? Unity_ObjectType.Trigger : Unity_ObjectType.Object;
