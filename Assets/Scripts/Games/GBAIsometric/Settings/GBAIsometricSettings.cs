            ...
            switch (engineVersion)
            {
                case GBAIsometricEngineVersion.Spyro1:
                    Ice_SpriteSetOffsets = region switch
                    {
                        ...
                        // TODO: Generate palette pointers from EU version
                        ...
                        GBAIsometricRegion.JP => new (uint SpriteSetOffset, uint PaletteOffset)[]
                        {
                            ...
                            (0x082648B8, 0x00), // 27
                            (0x08267450, 0x00), // 28
                            (0x084A9F40, 0x00), // 29 (modified)
                            (0x08564628, 0x00), // 30
                            (0x0858A360, 0x00), // 31
                            (0x0858A95C, 0x00), // 32 (modified)
                            (0x0858AF58, 0x00), // 33
                            (0x085C14E0, 0x00), // 34
                            (0x085C2364, 0x00), // 35
                            (0x085C2F9C, 0x00), // 36
                            ...
                            (0x085C48F0, 0x00), // 40
                            (0x085C4F80, 0x00), // 41
                            (0x085C59BC, 0x00), // 42 (modified)
                            (0x085C604C, 0x00), // 43
                            (0x085C67F0, 0x00), // 44 (modified)
                            (0x085C6E80, 0x00), // 45
                            (0x085C73F8, 0x00), // 46
                            (0x085C7A10, 0x00), // 47
                            (0x085CADAC, 0x00), // 48
