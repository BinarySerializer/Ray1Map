...
namespace Ray1Map.GBAVV
{
    public class GBAVV_Isometric_MapData : BinarySerializable
    {
        ...
        public GBAVV_Isometric_CollisionType[] CollisionTypes { get; set; }

        public GBAVV_Isometric_UnkStruct_0[] Pointer_4C_Structs { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            XPosition = s.SerializeObject<FixedPointInt32>(XPosition, name: nameof(XPosition));
            YPosition = s.SerializeObject<FixedPointInt32>(YPosition, name: nameof(YPosition));
            ...
            s.DoAt(Pointer_4C, () =>
            {
                ...
                {
                    s.SerializeObjectArray<GBAVV_Isometric_UnkStruct_0>(Pointer_4C_Structs, Pointer_4C_Structs.Length, name: nameof(Pointer_4C_Structs));
                }
            });
        }
    }
