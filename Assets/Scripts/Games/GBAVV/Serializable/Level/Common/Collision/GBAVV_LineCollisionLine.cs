...
namespace Ray1Map.GBAVV
{
    public class GBAVV_LineCollisionLine : BinarySerializable
    {
        ...
        public FixedPointInt32 FixedPoint_X1 { get; set; }
        public FixedPointInt32 FixedPoint_Y1 { get; set; }
        public FixedPointInt32 FixedPoint_X2 { get; set; }
        public FixedPointInt32 FixedPoint_Y2 { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            {
                FixedPoint_X1 = s.SerializeObject<FixedPointInt32>(FixedPoint_X1, x => x.Pre_PointPosition = 8, name: nameof(FixedPoint_X1));
                FixedPoint_Y1 = s.SerializeObject<FixedPointInt32>(FixedPoint_Y1, x => x.Pre_PointPosition = 8, name: nameof(FixedPoint_Y1));
                FixedPoint_X2 = s.SerializeObject<FixedPointInt32>(FixedPoint_X2, x => x.Pre_PointPosition = 8, name: nameof(FixedPoint_X2));
                FixedPoint_Y2 = s.SerializeObject<FixedPointInt32>(FixedPoint_Y2, x => x.Pre_PointPosition = 8, name: nameof(FixedPoint_Y2));
            }
            else
            {
