...
namespace Ray1Map.GBAVV
{
    public class GBAVV_ROM_Crash2 : GBAVV_ROM_Crash
    {
        ...
        public override void SerializeAdditionalData(SerializerObject s, Dictionary<DefinedPointer, Pointer> pointerTable)
        {
            ...
            CutsceneTable = s.DoAt(pointerTable.TryGetItem(DefinedPointer.Crash2_CutsceneTable), () => s.SerializeObjectArray<GBAVV_Crash2_CutsceneEntry>(CutsceneTable, isJp ? 55 : 54, name: nameof(CutsceneTable)));

            if (SerializeFLC)
                FLCTable = s.DoAt(pointerTable.TryGetItem(DefinedPointer.Crash2_FLCTable), () => s.SerializeObjectArray<GBAVV_Crash2_FLCTableEntry>(FLCTable, isJp ? 25 : 24, name: nameof(FLCTable)));

            if (CurrentLevInfo.IsWorldMap)
                WorldMap = s.DoAt(pointerTable.TryGetItem(DefinedPointer.Crash2_WorldMap), () => s.SerializeObject<GBAVV_Map>(WorldMap, name: nameof(WorldMap)));
        }

        public override void SerializeIsometric(SerializerObject s, Dictionary<DefinedPointer, Pointer> pointerTable)
        {
            var index3D = CurrentMapInfo.Index3D;

            s.DoAt(pointerTable[DefinedPointer.Isometric_MapDatas], () =>
            {
            ...
            s.DoAt(pointerTable[DefinedPointer.Isometric_ObjectDatas], () =>
            {
            ...
            Isometric_CharacterInfos = s.DoAt(pointerTable[DefinedPointer.Isometric_Characters], () => s.SerializeObjectArray<GBAVV_Isometric_CharacterInfo>(Isometric_CharacterInfos, 12, name: nameof(Isometric_CharacterInfos)));
            ...
            {
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim0_Frames], 0x03, 4, 4, 2), // Green barrel
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim1_Frames], 0x03, 4, 4, 2), // Laser beam
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim2_Frames], 0x06, 4, 4, 1), // Crate breaks
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim3_Frames], 0x07, 4, 4, 1), // Checkpoint breaks
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim4_Frames], 0x18, 8, 4, 0), // Checkpoint text
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim5_Frames], 0x08, 4, 4, 2), // Nitro explosion
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim6_Frames], 0x08, 4, 4, 2), // Nitro switch
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim7_Frames], 0x0E, 4, 4, 0), // Wumpa HUD
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim8_Frames], 0x0A, 8, 8, pointerTable[DefinedPointer.Isometric_AdditionalAnim8_Palette]), // Crystal collected
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim9_Frames], 0x03, 4, 4, pointerTable[DefinedPointer.Isometric_AdditionalAnim9_Palette]), // Multiplayer base
                GBAVV_Isometric_Animation.CrateAndSerialize(s, pointerTable[DefinedPointer.Isometric_AdditionalAnim10_Frames], 0x0A, 2, 2, pointerTable[DefinedPointer.Isometric_AdditionalAnim10_Palette]), // Multiplayer item
            };
        }
    }
}