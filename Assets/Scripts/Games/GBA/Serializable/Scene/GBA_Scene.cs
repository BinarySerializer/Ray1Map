...
namespace Ray1Map.GBA
{
    public class GBA_Scene : GBA_BaseBlock
    {
        ...
        public IEnumerable<GBA_Actor> GetAllActors(GameSettings settings)
        {
            ...
            else if (settings.EngineVersion < EngineVersion.GBA_R3_NintendoE3ApprovalProto)
        ...
        public override void SerializeBlock(SerializerObject s)
        {
            ...
            else if (s.GetR1Settings().EngineVersion < EngineVersion.GBA_R3_NintendoE3ApprovalProto)
            {
