...
{
    public class Unity_Object_GBA : Unity_SpriteObject_3D
    {
        ...
        public override Unity_ObjectType Type => Actor.Type == GBA_Actor.ActorType.Waypoint ? Unity_ObjectType.Waypoint : Actor.Type == GBA_Actor.ActorType.Captor ? Unity_ObjectType.Trigger : Unity_ObjectType.Object;
        ...
        private class LegacyEditorWrapper : BaseLegacyEditorWrapper
        {
            ...
            public override int SubEtatLength => Obj.ModelData?.Actions?.Length > 0 ? Obj.ModelData?.Actions?.Length ?? 0 : Obj.ModelData?.Puppets[Obj.PuppetIndex].Animations.Count ?? 0;
        }
