...
namespace Ray1Map
{
    public class Unity_SpriteObjBehaviour : Unity_ObjBehaviour
    {
        #region Public Properties

        public new Unity_SpriteObject ObjData
        {
            get => base.ObjData as Unity_SpriteObject;
            set => base.ObjData = value;
        }
        public float UpdateTimer { get; set; }
        public override bool ShowGizmo => Settings.ShowDefaultObjIcons
        ...
        public override bool EnableBoxCollider => IsVisible && (ObjData.CurrentAnimation != null || ShowGizmo || (HasObjCollision && ShowCollision));
        public override bool HasObjCollision => ObjData.ObjCollision?.Any() == true;
        ...
        void Update()
        {
            ...
            if (!(UpdateTimer > 1.0f / LevelEditorData.FramesPerSecond))
                return;
