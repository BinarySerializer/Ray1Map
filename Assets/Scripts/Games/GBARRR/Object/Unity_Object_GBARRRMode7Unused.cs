...
{
    public class Unity_Object_GBARRRMode7Unused : Unity_SpriteObject_3D
    {
        ...
        private class LegacyEditorWrapper : BaseLegacyEditorWrapper
        {
            ...
            public override int SubEtatLength => Obj.ObjManager?.GraphicsDatas?.ElementAtOrDefault(Obj.AnimationGroupIndex)?.Sprites.Length ?? 0;
        }
		#endregion
	}
}