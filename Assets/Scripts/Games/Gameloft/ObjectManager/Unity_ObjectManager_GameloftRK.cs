...
namespace Ray1Map.Gameloft
{
    public class Unity_ObjectManager_GameloftRK : Unity_ObjectManager
    {
		...
		public override Unity_SpriteObject GetMainObject(IList<Unity_SpriteObject> objects) => objects.OfType<Unity_Object_GameloftRK>().FindItem(x => x.ObjectName == "Player");
