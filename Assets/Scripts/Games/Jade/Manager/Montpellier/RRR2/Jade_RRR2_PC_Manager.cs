namespace Ray1Map
{
    public class Jade_RRR2_PC_Manager : Jade_Montpellier_BaseManager 
    {
        // Levels
        public override LevelInfo[] LevelInfos => new LevelInfo[] {
            ...
            new LevelInfo(0x00000B84, "ROOT/EngineDatas/06 Levels/__old/_main/_main_Menu_Interface", "_main_Menu_Interface.wol"),
