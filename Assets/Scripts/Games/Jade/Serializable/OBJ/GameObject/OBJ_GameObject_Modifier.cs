	...
	public class OBJ_GameObject_Modifier : BinarySerializable {
		...
		public override void SerializeImpl(SerializerObject s) {
            ...
            Modifier = Type switch
            {
                ...
                MDF_ModifierType.Modifier56 => s.SerializeObject<MDF_ModifierPhoenix56>((MDF_ModifierPhoenix56)Modifier, name: nameof(Modifier)),
                MDF_ModifierType.Modifier57 => s.SerializeObject<MDF_ModifierPhoenix57>((MDF_ModifierPhoenix57)Modifier, name: nameof(Modifier)),
        ...
        public void SerializeImpl_Montreal(SerializerObject s) {
            ...
            Modifier = Type_Montreal switch
            {
                ...
                MDF_ModifierType_Montreal.GAO_ModifierAnimatedPAG => s.SerializeObject<GAO_ModifierAnimatedPAG>((GAO_ModifierAnimatedPAG)Modifier, name: nameof(Modifier)),
                MDF_ModifierType_Montreal.GAO_ModifierAnimatedMaterial => s.SerializeObject<GAO_ModifierAnimatedMaterial>((GAO_ModifierAnimatedMaterial)Modifier, name: nameof(Modifier)),
                ...
                MDF_ModifierType_Montreal.AmbiancePocket_Modifier => s.SerializeObject<AmbiancePocket_Modifier>((AmbiancePocket_Modifier)Modifier, name: nameof(Modifier)),
                ...
                MDF_ModifierType_Montreal.GAO_ModifierExplode => s.SerializeObject<GAO_ModifierExplode>((GAO_ModifierExplode)Modifier, name: nameof(Modifier)),
                MDF_ModifierType_Montreal.GAO_ModifierEcharpe => s.SerializeObject<GAO_ModifierEcharpe>((GAO_ModifierEcharpe)Modifier, name: nameof(Modifier)),
                MDF_ModifierType_Montreal.GAO_ModifierSoftBodyColl => s.SerializeObject<GAO_ModifierSoftBodyColl>((GAO_ModifierSoftBodyColl)Modifier, name: nameof(Modifier)),
