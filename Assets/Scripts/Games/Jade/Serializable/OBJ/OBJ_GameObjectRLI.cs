...
namespace Ray1Map.Jade {
	public class OBJ_GameObjectRLI : Jade_File {
		...
		public SerializableColor[] VertexRLI { get; set; }
		...
		protected override void SerializeFile(SerializerObject s) {
			...
			VertexRLI = s.SerializeIntoArray<SerializableColor>(VertexRLI, VertexColorsCount, BitwiseColor.RGBA8888, name: nameof(VertexRLI));
		}
	}
}
