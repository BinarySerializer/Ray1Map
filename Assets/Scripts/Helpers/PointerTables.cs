        ...
        public static Dictionary<GBA.DefinedPointer, Pointer> GBA_PointerTable(Context context, BinaryFile romFile)
        {
            switch (context.GetR1Settings().GameModeSelection)
            {
				...
				case GameModeSelection.Rayman3GBA_20020301_PreAlpha:
					return new Dictionary<GBA.DefinedPointer, uint>() {
						[GBA.DefinedPointer.UiOffsetTable] = 0x08156318,
					}.ToDictionary(x => x.Key, x => new Pointer(x.Value, romFile));

				case GameModeSelection.Rayman3GBA_20020308_PreAlphaB:
					return new Dictionary<GBA.DefinedPointer, uint>() {
						[GBA.DefinedPointer.UiOffsetTable] = 0x0815ADD0,
					}.ToDictionary(x => x.Key, x => new Pointer(x.Value, romFile));

				case GameModeSelection.Rayman3GBA_20020318_FocusGroup:
					return new Dictionary<GBA.DefinedPointer, uint>() {
						[GBA.DefinedPointer.UiOffsetTable] = 0x080DA7CC,
					}.ToDictionary(x => x.Key, x => new Pointer(x.Value, romFile));
				...
				case GameModeSelection.Rayman3GBA_20020719_LaRonde:
					return new Dictionary<GBA.DefinedPointer, uint>() {
                ...
                case GameModeSelection.Rayman3GBA_20020809_ECTS:
					return new Dictionary<GBA.DefinedPointer, uint>() {
						...
						[GBA.DefinedPointer.LevelInfo] = 0x080af93c,
						[GBA.DefinedPointer.Localization] = 0x080acedc,
					}.ToDictionary(x => x.Key, x => new Pointer(x.Value, romFile));
				...
				case GameModeSelection.TheSumOfAllFearsEU:
				case GameModeSelection.TheSumOfAllFearsUS:
					return new Dictionary<GBA.DefinedPointer, uint>() {
						[GBA.DefinedPointer.UiOffsetTable] = 0x0804A844,
					}.ToDictionary(x => x.Key, x => new Pointer(x.Value, romFile));
            ...
            switch (gameMode) 
            {
                case GameModeSelection.SpyroSeasonIceEU:
                    return new Dictionary<Spyro_DefinedPointer, uint>() {
                        ...
                        [Spyro_DefinedPointer.Ice_Level3D_MapLayers] = 0x081aec38,
                        [Spyro_DefinedPointer.Ice_Level3D_TileSets] = 0x081aed8c,
                        [Spyro_DefinedPointer.Ice_Level3D_TileSetLengths] = 0x08061be8,
                        [Spyro_DefinedPointer.Ice_Level3D_MapCollision] = 0x081aeb64,
                        [Spyro_DefinedPointer.Ice_Level3D_Objects] = 0x081aee14,
