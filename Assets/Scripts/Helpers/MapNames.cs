...
namespace R1Engine
{
    ...
    public class BaseINIFile
    {
        ...
        /// <summary>
        /// Reads the sections from a .ini stream
        /// </summary>
        /// <param name="inputStream">The stream to read from</param>
        public void Read(Stream inputStream)
        {
            // Use a reader
            using (var reader = new StreamReader(inputStream, Encoding.UTF8, true, 512, true))
            {
                // Helper for getting the next line
                string nextLine()
                {
                    string l = String.Empty;

                    // Read until we get a valid line or reach the end of the file
                ...
                // Read each section until we reach the end of the file
