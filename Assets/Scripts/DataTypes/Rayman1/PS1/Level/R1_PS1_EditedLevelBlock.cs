namespace R1Engine
{
    public class R1_PS1_EditedLevelBlock : R1Serializable
    {
        ...
        // Parsed
        public R1_EventData[] OriginalEvents { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            s.DoAt(OriginalEventsPointer, () => OriginalEvents = s.SerializeObjectArray<R1_EventData>(OriginalEvents, OriginalEventCount, name: nameof(OriginalEvents)));
