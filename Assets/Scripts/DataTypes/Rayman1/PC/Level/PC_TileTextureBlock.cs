namespace R1Engine
{
    ...
    /// </summary>
    public class PC_TileTextureBlock : R1Serializable
    {
        /// <summary>
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            {
                s.DoXOR((byte)(s.GameSettings.EngineVersion == EngineVersion.RayPC || s.GameSettings.EngineVersion == EngineVersion.RayPocketPC ? 0 : 0xFF), () =>
                {
