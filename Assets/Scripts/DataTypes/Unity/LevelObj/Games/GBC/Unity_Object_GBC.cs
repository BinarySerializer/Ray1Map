...
namespace R1Engine
{
    public class Unity_Object_GBC : Unity_SpriteObject
    {
        ...
        public override Unity_ObjectType Type => IsTrigger ? Unity_ObjectType.Trigger : Unity_ObjectType.Object;
        ...
        private class LegacyEditorWrapper : BaseLegacyEditorWrapper
        {
            ...
            public override int SubEtatLength => Obj.ActorModel?.Actions?.Length > 0 ? Obj.ActorModel?.Actions?.Length ?? 0 : Obj.ActorModel?.Graphics?.Animations.Count ?? 0;
        }
