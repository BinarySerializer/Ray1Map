namespace R1Engine
{
    ...
    /// </summary>
    public class PS1_R2Demo_AllfixFooter : R1Serializable
    {
        ...
        /// </summary>
        public PS1_R2Demo_EventAnimGroup RaymanAnimGroup { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            s.DoAt(RaymanAnimGroupPointer, () => RaymanAnimGroup = s.SerializeObject<PS1_R2Demo_EventAnimGroup>(RaymanAnimGroup, name: nameof(RaymanAnimGroup)));
        }
    }
}