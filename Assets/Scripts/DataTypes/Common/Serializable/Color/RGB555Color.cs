...
namespace R1Engine
{
    ...
    /// </summary>
    public class RGB555Color : ARGBColor
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        public RGB555Color() : base(255, 0, 0, 0)
        { }

        public RGB555Color(byte red, byte green, byte blue) : base(red, green, blue)
        { }

        public RGB555Color(byte alpha, byte red, byte green, byte blue) : base(alpha, red, green, blue)
        { }
        ...
        public override void SerializeImpl(SerializerObject s) {
            Color555 = s.Serialize<ushort>(Color555, name: nameof(Color555));
        }
    }
}