    ...
    public class Common_Lev
    {
        ...
        public void AutoApplyPalette()
        {
            ...
            if (isPaletteHorizontal && paletteXChangers.Any())
            {
                ...
                {
                    case PaletteChangerMode.Left1toRight2:
                    case PaletteChangerMode.Left1toRight3:
                        defaultPalette = 1;
                        break;
                    case PaletteChangerMode.Left2toRight1:
                    case PaletteChangerMode.Left2toRight3:
                        defaultPalette = 2;
                        break;
                    case PaletteChangerMode.Left3toRight1:
                    case PaletteChangerMode.Left3toRight2:
                        defaultPalette = 3;
                        break;
                }
            }
            else if (!isPaletteHorizontal && paletteYChangers.Any())
            {
                ...
                {
                    case PaletteChangerMode.Top1tobottom2:
                    case PaletteChangerMode.Top1tobottom3:
                        defaultPalette = 1;
                        break;
                    case PaletteChangerMode.Top2tobottom1:
                    case PaletteChangerMode.Top2tobottom3:
                        defaultPalette = 2;
                        break;
                    case PaletteChangerMode.Top3tobottom1:
                    case PaletteChangerMode.Top3tobottom2:
                        defaultPalette = 3;
                        break;
                }
            }
