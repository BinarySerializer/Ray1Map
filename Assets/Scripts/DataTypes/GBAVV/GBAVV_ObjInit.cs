...
namespace R1Engine
{
    public static class GBAVV_ObjInit
    {
        ...
        public static void InitObj(GameSettings settings, Unity_Object_GBAVVNitroKart obj, int objType)
        {
            if (settings.EngineVersion == EngineVersion.GBAVV_CrashNitroKart)
            {
                switch ((GBAVV_NitroKart_ObjType)objType)
                {
                    case GBAVV_NitroKart_ObjType.StartPos_3:
                    case GBAVV_NitroKart_ObjType.StartPos_4:
                    case GBAVV_NitroKart_ObjType.StartPos_5:
                    case GBAVV_NitroKart_ObjType.StartPos_6:
                    case GBAVV_NitroKart_ObjType.StartPos_7:
                    case GBAVV_NitroKart_ObjType.StartPos_8:
                    case GBAVV_NitroKart_ObjType.StartPos_9:
                    case GBAVV_NitroKart_ObjType.StartPos_10:
                        obj.SetAnimation(-1, -1, 0);
                        obj.IsWaypoint = true;
                        break;

                    case GBAVV_NitroKart_ObjType.Letter_C: obj.SetAnimation(2, 3, 0); break;
                    case GBAVV_NitroKart_ObjType.Letter_N: obj.SetAnimation(2, 3, 2); break;
                    case GBAVV_NitroKart_ObjType.Letter_K: obj.SetAnimation(2, 3, 1); break;

                    case GBAVV_NitroKart_ObjType.Crate_QuestionMark: obj.SetAnimation(2, 1, 1); break;
                    case GBAVV_NitroKart_ObjType.Crate_Bounce: obj.SetAnimation(2, 2, 1); break;
                    case GBAVV_NitroKart_ObjType.Wumpa: obj.SetAnimation(2, 0, 0); break;
                    case GBAVV_NitroKart_ObjType.Crate_Time1: obj.SetAnimation(2, 4, 1); break;
                    case GBAVV_NitroKart_ObjType.Crate_Time2: obj.SetAnimation(2, 5, 1); break;
                    case GBAVV_NitroKart_ObjType.Crate_Time3: obj.SetAnimation(2, 6, 1); break;

                    case GBAVV_NitroKart_ObjType.Scenery_45: obj.SetAnimation(20, 0, 0); break;
                    case GBAVV_NitroKart_ObjType.Scenery_49: obj.SetAnimation(20, 1, 0); break;
                    case GBAVV_NitroKart_ObjType.Scenery_77: obj.SetAnimation(3, 0, 0); break;
    ...
    public enum GBAVV_NitroKart_ObjType
    {
        None = 0,
