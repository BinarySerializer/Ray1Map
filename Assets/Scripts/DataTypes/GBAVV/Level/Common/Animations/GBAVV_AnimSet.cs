...
namespace R1Engine
{
    public class GBAVV_AnimSet : BinarySerializable
    {
        ...
        public GBAVV_Animation[] Animations { get; set; }
        public Pointer[] FramePointers { get; set; }
        public GBAVV_AnimationFrame[] AnimationFrames { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            if (s.GetR1Settings().EngineVersion >= EngineVersion.GBAVV_CrashNitroKart_NGage && s.GetR1Settings().EngineVersion != EngineVersion.GBAVV_KidsNextDoorOperationSODA)
            {
                ...
                Animations = s.SerializeObjectArray<GBAVV_Animation>(Animations, AnimationsCount, name: nameof(Animations));

                AnimationFrames = s.DoAt(FramesPointer, () => s.SerializeObjectArray<GBAVV_AnimationFrame>(AnimationFrames, FramesCount, name: nameof(AnimationFrames)));
            }
            else
            {
                ...
                Animations = s.DoAt(AnimationsPointer, () => s.SerializeObjectArray<GBAVV_Animation>(Animations, AnimationsCount, name: nameof(Animations)));
                ...
                if (AnimationFrames == null)
                    AnimationFrames = new GBAVV_AnimationFrame[FramePointers.Length];
