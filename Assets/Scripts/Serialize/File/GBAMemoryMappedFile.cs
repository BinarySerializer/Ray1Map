...
namespace R1Engine
{
    ...
    {
        public GBAMemoryMappedFile(Context context, string filePath, uint baseAddress, Endian endianness = Endian.Little, long? fileLength = null) : base(context, filePath, baseAddress, endianness, fileLength)
        { }
