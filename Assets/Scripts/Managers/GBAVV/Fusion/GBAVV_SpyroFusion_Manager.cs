...
namespace R1Engine
{
    public abstract class GBAVV_SpyroFusion_Manager : GBAVV_Fusion_Manager
    {
        ...
        {
            new FusionLevInfo(4, "Dragon Castles - Part 1"),
            new FusionLevInfo(6, "Dragon Castles - Part 2"),
            new FusionLevInfo(1, "Gate Crank"),
            new FusionLevInfo(68, "Castle Chaos"),
            new FusionLevInfo(36, "Fall In, Roll Out - Easy"),
            new FusionLevInfo(48, "Fall In, Roll Out - Normal"),
            new FusionLevInfo(49, "Fall In, Roll Out - Hard"),
            new FusionLevInfo(11, "Rumble on the Ramparts"),
            new FusionLevInfo(31, "Castle Cruisin' - Easy"),
            new FusionLevInfo(54, "Castle Cruisin' - Normal"),
            new FusionLevInfo(55, "Castle Cruisin' - Hard"),
            new FusionLevInfo(39, "Altitude Adjustment - Easy"),
            new FusionLevInfo(58, "Altitude Adjustment - Normal"),
            new FusionLevInfo(59, "Altitude Adjustment - Hard"),
            new FusionLevInfo(7, "Portal Rush"),
            new FusionLevInfo(17, "Gem Rush"),
            new FusionLevInfo(92, "Crash Bandicoot"),
            new FusionLevInfo(75, "Gem Chaser"),
            new FusionLevInfo(79, "Dragon Drop"),
            new FusionLevInfo(73, "Death From Behind"),

            new FusionLevInfo(12, "Arctic Cliffs - Part 1"),
            new FusionLevInfo(13, "Arctic Cliffs - Part 2"),
            new FusionLevInfo(9, "Fire and Ice"),
            new FusionLevInfo(33, "Snow Steps - Easy"),
            new FusionLevInfo(64, "Snow Steps - Normal"),
            new FusionLevInfo(65, "Snow Steps - Hard"),
            new FusionLevInfo(28, "Arctic Attack - Easy"),
            new FusionLevInfo(44, "Arctic Attack - Normal"),
            new FusionLevInfo(45, "Arctic Attack - Hard"),
            new FusionLevInfo(85, "Blizzard Balls"),
            new FusionLevInfo(37, "Tread Lightly - Easy"),
            new FusionLevInfo(50, "Tread Lightly - Normal"),
            new FusionLevInfo(51, "Tread Lightly - Hard"),
            new FusionLevInfo(5, "Ice Chopper"),
            new FusionLevInfo(18, "Portal Rush"),
            new FusionLevInfo(19, "Gem Rush"),
            new FusionLevInfo(3, "Crush and Gulp"),
            new FusionLevInfo(76, "Gem Chaser"),
            new FusionLevInfo(81, "Icicle Canyon"),
            new FusionLevInfo(70, "Sheep Shearin'"),
            new FusionLevInfo(89, "Bridge Fight"),

            new FusionLevInfo(0, "Fire Mountains - Part 1"),
            new FusionLevInfo(14, "Fire Mountains - Part 2"),
            new FusionLevInfo(10, "Wall of Fire"),
            new FusionLevInfo(30, "Fire Fight - Easy"),
            new FusionLevInfo(42, "Fire Fight - Normal"),
            new FusionLevInfo(43, "Fire Fight - Hard"),
            new FusionLevInfo(86, "Ring Of Fire"),
            new FusionLevInfo(90, "Turn Up the Heat"),
            new FusionLevInfo(2, "Pull Of Lava"),
            new FusionLevInfo(40, "Hot Wings - Easy"),
            new FusionLevInfo(60, "Hot Wings - Normal"),
            new FusionLevInfo(61, "Hot Wings - Hard"),
            new FusionLevInfo(20, "Portal Rush"),
            new FusionLevInfo(21, "Gem Rush"),
            new FusionLevInfo(27, "Nina Cortex"),
            new FusionLevInfo(77, "Gem Chaser"),
            new FusionLevInfo(80, "Lava Fields"),
            new FusionLevInfo(74, "Sheep Shakedown"),

            new FusionLevInfo(15, "Wumpa Jungle - Part 1"),
            new FusionLevInfo(16, "Wumpa Jungle - Part 2"),
            new FusionLevInfo(8, "Crank It Up"),
            new FusionLevInfo(32, "Riptocs And Rockets - Easy"),
            new FusionLevInfo(56, "Riptocs And Rockets - Normal"),
            new FusionLevInfo(57, "Riptocs And Rockets - Hard"),
            new FusionLevInfo(41, "Treetop Flight - Easy"),
            new FusionLevInfo(62, "Treetop Flight - Normal"),
            new FusionLevInfo(63, "Treetop Flight - Hard"),
            new FusionLevInfo(35, "Falling To Pieces"),
            new FusionLevInfo(87, "Riptoc Repellent"),
            new FusionLevInfo(38, "Dragon Assault - Easy"),
            new FusionLevInfo(52, "Dragon Assault - Normal"),
            new FusionLevInfo(53, "Dragon Assault - Hard"),
            new FusionLevInfo(22, "Portal Rush"),
            new FusionLevInfo(23, "Gem Rush"),
            new FusionLevInfo(72, "Neo Cortex"),
            new FusionLevInfo(78, "Gem Chaser"),
            new FusionLevInfo(71, "Gem Hop"),
            new FusionLevInfo(82, "Sheep Chase"),

            new FusionLevInfo(24, "Tech Park - Part 1"),
            new FusionLevInfo(83, "Tech Park - Part 2"),
            new FusionLevInfo(91, "Gravity Well"),
            new FusionLevInfo(29, "Space Shoot - Easy"),
            new FusionLevInfo(46, "Space Shoot - Normal"),
            new FusionLevInfo(47, "Space Shoot - Hard"),
            new FusionLevInfo(84, "Tech Tug"),
            new FusionLevInfo(34, "Sky Walker - Easy"),
            new FusionLevInfo(66, "Sky Walker - Normal"),
            new FusionLevInfo(67, "Sky Walker - Hard"),
            new FusionLevInfo(88, "Tech Deflect"),
            new FusionLevInfo(25, "Portal Rush"),
            new FusionLevInfo(26, "Gem Rush"),
            new FusionLevInfo(69, "Space Chase"),
        };
    ...
    public class GBAVV_SpyroFusionEU_Manager : GBAVV_SpyroFusion_Manager
    {
        ...
        {
	        
        };
    ...
    public class GBAVV_SpyroFusionUS_Manager : GBAVV_SpyroFusion_Manager
    {
        ...
        public override byte[] HardCodedScripts => new byte[] 
        {
	        
        };
    ...
    public class GBAVV_SpyroFusionUS2_Manager : GBAVV_SpyroFusion_Manager
    {
        ...
        public override byte[] HardCodedScripts => new byte[] 
        {
	        ,
	        ...
	        ,
	        ...
	        ,
	        ...
	        ,
	        ...
	        ,
	        ...
	        
        };
    ...
    public class GBAVV_SpyroFusionJP_Manager : GBAVV_SpyroFusion_Manager
    {
        ...
        public override byte[] HardCodedScripts => new byte[]
{
            
        };
